...
from stsw.writer.writer import StreamWriter, TensorOrderError, LengthMismatchError
...
class TestWriterFinalCoverage:
    ...
    def test_writer_write_wrong_order(self, tmp_path):
        ...
        with pytest.raises(TensorOrderError, match="Expected tensor 'tensor1' but got 'tensor2'"):
    ...
    def test_writer_write_too_much_data(self, tmp_path):
        ...
        with pytest.raises(LengthMismatchError, match="expects 40 more bytes, but got 50"):
    ...
    def test_writer_partial_write_then_too_much(self, tmp_path):
        ...
        with pytest.raises(LengthMismatchError, match="expects 20 more bytes, but got 30"):
    ...
    def test_writer_finalize_incomplete_tensor(self, tmp_path):
        ...
        with pytest.raises(LengthMismatchError, match="expects 40 bytes, but only 20 were written"):
